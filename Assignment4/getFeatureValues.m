function[meanMat, varianceMat, rmsMat, entropyMat, wilsonMat, VCMat] = getFeatureValues(actionMatrix)
    ...
    VCMat       = NaN(noOfFeatures, noOfSamples);
    ...
    for i=1:noOfRowsAndColumns(1)
        ...
        [avg, variance, rmsValue, entropyVal, wilsonAmp, valCrossing]= getStatistics(sample);
        ...
        VCMat(featureIndex, sampleIndex)        = valCrossing;  
    end
end
